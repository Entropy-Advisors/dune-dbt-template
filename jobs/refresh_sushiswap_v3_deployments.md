# Job: Refresh SushiSwap V3 Factory Deployments

## Goal

Check for new SushiSwap V3 factory contract deployments that are not yet tracked in this project, and add them to `dim_dex_factory_addresses.sql`.
...
SushiSwap's official V3 deployment registry:
https://github.com/sushiswap/v3-core
...
**Important:** Uniswap V3 and PancakeSwap V3 share the same topic0 (SushiSwap V3 forked Uniswap V3). Do not confuse SushiSwap V3 factory addresses with those protocols. Only add addresses from the official SushiSwap V3 docs.
