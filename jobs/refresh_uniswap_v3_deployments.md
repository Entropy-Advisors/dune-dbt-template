# Job: Refresh Uniswap V3 Factory Deployments

## Goal

Check for new Uniswap V3 factory contract deployments that are not yet tracked in this project, and add them to `dim_dex_factory_addresses.sql`.
...
Uniswap's official V3 deployment registry:
...
**Important:** SushiSwap V3 and PancakeSwap V3 share the same topic0 (all forked from Uniswap V3). Do not confuse Uniswap V3 factory addresses with those protocols. Only add addresses from the official Uniswap V3 docs.
