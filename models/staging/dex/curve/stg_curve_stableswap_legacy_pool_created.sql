...
select
    ...
    coins[1]                                                                   as token0,
    coins[2]                                                                   as token1,
    if(coins[3] != 0x0000000000000000000000000000000000000000, coins[3], null) as token2,
    if(coins[4] != 0x0000000000000000000000000000000000000000, coins[4], null) as token3,
    coins,
    "A"                                                                        as a,
    fee,
    deployer
