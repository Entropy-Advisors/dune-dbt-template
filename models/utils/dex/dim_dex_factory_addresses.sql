...
from (
    values
        ...
        -- Curve StableSwap NG
        ('curve', 'stableswap_ng', 'ethereum',    0x6A8cbed756804B16E05E741eDaBd5cB544AE21bf, 18427841),
        ('curve', 'stableswap_ng', 'polygon',     0x1764ee18e8B3ccA4787249Ceb249356192594585, 50625140),
        ('curve', 'stableswap_ng', 'fantom',      0xe61Fb97Ef6eBFBa12B36Ffd7be785c1F5A2DE66b, 72534264),
        ('curve', 'stableswap_ng', 'avalanche_c', 0x1764ee18e8B3ccA4787249Ceb249356192594585, 38813389),
        ('curve', 'stableswap_ng', 'arbitrum',    0x9AF14D26075f142eb3F292D5065EB3faa646167b, 161986628),
        ('curve', 'stableswap_ng', 'optimism',    0x5eeE3091f747E60a045a2E715a4c71e600e31F6E, 113744803),
        ('curve', 'stableswap_ng', 'gnosis',      0xbC0797015fcFc47d9C1856639CaE50D0e69FbEE8, 30508168),
        ('curve', 'stableswap_ng', 'celo',        0x1764ee18e8B3ccA4787249Ceb249356192594585, 24159876),
        ('curve', 'stableswap_ng', 'zksync',      0xFcAb5d04e8e031334D5e8D2C166B08daB0BE6CaE, null),
        ('curve', 'stableswap_ng', 'base',        0xd2002373543Ce3527023C75e7518C274A51ce712, 7886150),
        ('curve', 'stableswap_ng', 'mantle',      0x5eeE3091f747E60a045a2E715a4c71e600e31F6E, 66300283),
        ...
        -- Curve TwoCrypto NG
        ('curve', 'twocrypto_ng', 'ethereum',    0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 19379915),
        ('curve', 'twocrypto_ng', 'polygon',     0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 54112723),
        ('curve', 'twocrypto_ng', 'fantom',      0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 77978455),
        ('curve', 'twocrypto_ng', 'avalanche_c', 0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, null),
        ('curve', 'twocrypto_ng', 'arbitrum',    0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 170353220),
        ('curve', 'twocrypto_ng', 'optimism',    0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 116821340),
        ('curve', 'twocrypto_ng', 'gnosis',      0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 32699751),
        ('curve', 'twocrypto_ng', 'celo',        0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 24649549),
        ('curve', 'twocrypto_ng', 'zksync',      0xf3a546AF64aFd6BB8292746BA66DB33aFAE72114, null),
        ('curve', 'twocrypto_ng', 'base',        0xc9Fe0C63Af9A39402e8a5514f9c43Af0322b665F, 11290497),
        ('curve', 'twocrypto_ng', 'bnb',         0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 36737133),
        ('curve', 'twocrypto_ng', 'fraxtal',     0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, null),
        ('curve', 'twocrypto_ng', 'mantle',      0x98EE851a00abeE0d95D08cF4CA2BdCE32aeaAF7F, 72840206),

        -- Curve Tricrypto NG
        ('curve', 'tricrypto_ng', 'ethereum',    0x0c0e5f2fF0ff18a3be9b835635039256dC4B4963, 17371455),
        ('curve', 'tricrypto_ng', 'polygon',     0xC1b393EfEF38140662b91441C6710Aa704973228, 55965919),
        ('curve', 'tricrypto_ng', 'fantom',      0x9AF14D26075f142eb3F292D5065EB3faa646167b, 119023773),
        ('curve', 'tricrypto_ng', 'avalanche_c', 0x3d6cB2F6DcF47CDd9C13E4e3beAe9af041d8796a, 67007721),
        ('curve', 'tricrypto_ng', 'arbitrum',    0xbC0797015fcFc47d9C1856639CaE50D0e69FbEE8, 99388928),
        ('curve', 'tricrypto_ng', 'optimism',    0xc6C09471Ee39C7E30a067952FcC89c8922f9Ab53, 118124783),
        ...
        ('curve', 'tricrypto_ng', 'base',        0xA5961898870943c68037F6848d2D866Ed2016bcB, 3194266),
        ('curve', 'tricrypto_ng', 'bnb',         0xc55837710bc500F1E3c7bb9dd1d51F7c5647E657, 41392921),
        ...
        -- Balancer V2 (Vault — one per chain, same address on all chains)
        -- TokensRegistered event: pool tokens are registered here; pool address = first 20 bytes of poolId
        ('balancer', '2', 'ethereum',    0xBA12222222228d8Ba445958a75a0704d566BF2C8, 10635457),
        ('balancer', '2', 'arbitrum',    0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'polygon',     0xBA12222222228d8Ba445958a75a0704d566BF2C8, 15832990),
        ('balancer', '2', 'optimism',    0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'gnosis',      0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'avalanche_c', 0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'bnb',         0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'base',        0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
        ('balancer', '2', 'zkevm',       0xBA12222222228d8Ba445958a75a0704d566BF2C8, null),
